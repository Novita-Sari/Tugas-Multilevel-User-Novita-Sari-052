...
<body>
  <form class="form-signin" method="POST" action="cek_login.php">
    <div class="text-center mb-4">
      <img class="mb-4" src="assets/brand/user.svg" alt="" width="72" height="72">
      <h1 class="h3 mb-3 font-weight-normal">Login Akun</h1>
    ...
    <p class="mt-5 mb-3 text-muted text-center">&copy; Created By Novita Sari | 20050974052</p>
  </form>
</body>
